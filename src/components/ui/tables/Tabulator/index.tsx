"use client";
import { Menu } from "@/app/base-components/Headless";
import { FormInput, FormSelect } from "@/app/base-components/Form";
...
import { stringToHTML } from "@/app/utils/helper";
              ...
              return response.images
                ? `<div class="flex lg:justify-center">
                    <div class="intro-x w-10 h-10 image-fit">
                      <img alt="Midone Tailwind HTML Admin Template" class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]" src="${"assets"}">
                    </div>
                    <div class="intro-x w-10 h-10 image-fit -ml-5">
                      <img alt="Midone Tailwind HTML Admin Template" class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]" src="${"/src/assets/"}>
                    </div>
                    <div class="intro-x w-10 h-10 image-fit -ml-5">
                      <img alt="Midone Tailwind HTML Admin Template" class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]" src="${"assets"}">
                    </div>
          ...
          <Menu className="ml-auto sm:ml-0">
            <Menu.Button as={Button} className="px-2 font-normal !box">
              <span className="flex items-center justify-center w-5 h-5">
                <Lucide name="Plus" className="w-4 h-4" />
              </span>
            </Menu.Button>
            <Menu.Items className="w-40">
              <Menu.Item>
                <Lucide name="FilePlus" className="w-4 h-4 mr-2" /> New Category
              </Menu.Item>
              <Menu.Item>
                <Lucide name="UserPlus" className="w-4 h-4 mr-2" /> New Group
              </Menu.Item>
            </Menu.Items>
          </Menu>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end xl:items-start">
          ...
          <div className="flex mt-5 sm:mt-0">
            ...
            <Menu className="w-1/2 sm:w-auto">
              ...
              >
                <Lucide name="FileText" className="w-4 h-4 mr-2" /> Export
                <Lucide
                  name="ChevronDown"
              ...
              <Menu.Items className="w-40">
                <Menu.Item onClick={onExportCsv}>
                  <Lucide name="FileText" className="w-4 h-4 mr-2" /> Export CSV
                </Menu.Item>
